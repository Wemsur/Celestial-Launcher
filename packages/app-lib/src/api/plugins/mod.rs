...
pub use store::{
    ...
    install, install_from_url, latest_release_tag, list, plugin_data_dir,
    plugins_dir, read_entry, resolve_entry, revoke_permission, set_enabled,
    set_granted, set_hot_reload, set_pinned_pages, uninstall, update,
    update_from_url,
};
